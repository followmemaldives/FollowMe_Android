package com.asif.followme.imageloader;
...
public class ImageLoader {
	...
	int		imageNotAvailbel	=	R.drawable.white_bg;
	...
	//	System.out.println(url+"....................................................................");
		...
		if(url.equalsIgnoreCase("")){
			pb.setVisibility(View.GONE);
			imageView.setImageResource(imageNotAvailbel);
	...
	public void DisplayProfileImage(String url, ImageView imageView,ProgressBar pb){
		//	System.out.println(url+"....................................................................");
		imageViews.put(imageView, url);
		Bitmap bitmap=memoryCache.get(url);
//		pb.setVisibility(View.GONE);
	...
	private class PhotoToLoad
	{
		...
		public PhotoToLoad(String u, ImageView i,ProgressBar progress)
		{
			url=u; 
			imageView=i;
	...
	class BitmapDisplayer implements Runnable
	{
		...
		public void run()
		{
			...
			if(bitmap!=null)
				...
				photoToLoad.imageView.setImageResource(imageNotAvailbel);
		}
	}
