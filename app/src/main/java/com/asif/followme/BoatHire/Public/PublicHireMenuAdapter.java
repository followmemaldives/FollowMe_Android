...
public class PublicHireMenuAdapter extends ArrayAdapter<PublicHireMenuActivity.MyMenu> {

    private final List<PublicHireMenuActivity.MyMenu> list;
    ...
    public PublicHireMenuAdapter(Activity context, List<PublicHireMenuActivity.MyMenu> list) {
