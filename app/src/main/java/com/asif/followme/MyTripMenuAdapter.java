...
public class MyTripMenuAdapter extends ArrayAdapter<MyTripMenuActivity.MyTripMenu> {

    private final List<MyTripMenuActivity.MyTripMenu> list;
    ...
    public MyTripMenuAdapter(Activity context, List<MyTripMenuActivity.MyTripMenu> list) {
