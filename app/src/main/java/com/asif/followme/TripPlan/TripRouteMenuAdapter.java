...
public class TripRouteMenuAdapter extends ArrayAdapter<TripRouteMenuActivity.MyMenu> {

    private final List<TripRouteMenuActivity.MyMenu> list;
    ...
    public TripRouteMenuAdapter(Activity context, List<TripRouteMenuActivity.MyMenu> list) {
