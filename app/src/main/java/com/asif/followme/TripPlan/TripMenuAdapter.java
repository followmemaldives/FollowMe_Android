...
public class TripMenuAdapter extends ArrayAdapter<TripMenuActivity.TripPlanMenu> {

    private final List<TripMenuActivity.TripPlanMenu> list;
    ...
    public TripMenuAdapter(Activity context, List<TripMenuActivity.TripPlanMenu> list) {
