...
public class PublicETAActivity extends Activity implements View.OnClickListener {
...
//        progressBar = (ProgressBar)  findViewById(R.id.loading_spinner);
    ...
    public void onStart() {
        super.onStart();
        etaTask=new ETATask("auto",PublicBoatsFragment.selected_item_id, 0);
        etaTask.execute();
    ...
    public class WebAppInterface {
        ...
        public void sendData(String element, String data) {
            ...
            try{
                ...
                PublicMapsActivity.etaDestPoint = new LatLng(lat,lon);

                PublicMapsActivity.etaIsland = etObj.getString("name");
...
//            progressBar.setVisibility(View.VISIBLE);
        ...
        protected String doInBackground(Void... arg0) {
            try{
                ...
                return parser.getETAPublic(context,action,device_id,fence_id);
            }
            catch(Exception ex) {
                ex.printStackTrace();
            }
                ...
                try {
                    ...
                    if (jObj.has("status")) {
                        if (jObj.getString("status").equalsIgnoreCase("ok")) {
                            ...
                            PublicMapsActivity.etaIsland = adapter.getItem(0).getName();
                            PublicMapsActivity.etaIslandLabel.setText(adapter.getItem(0).getName());
                            ...
                            destinationSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    if(dataETA.getId()==0){     //OTHER
                                        ...
                                        PublicMapsActivity.etaDestPoint = new LatLng(lat, lon);
                                        PublicMapsActivity.etaIsland = dataETA.getName();
                                    }
...
//        MyMapsActivity.etaDestPoint = p2;
        System.out.println("etaDestPoint:"+PublicMapsActivity.etaDestPoint+" +++++++++++++++++++++++++++++++++++++++");
        if(PublicMapsActivity.etaDestPoint==null){
            return;
        }

        Double d = getDistance(PublicMapsActivity.etaNowPoint,PublicMapsActivity.etaDestPoint);
//        String nm = String.format("%.1f",d * 0.000539957)+" NM";
//        distanceLabel.setText(nm);
        Double t = d / (PublicMapsActivity.etaNowSpeed * 0.514444);
        Calendar calendar = Calendar.getInstance(); // gets a calendar using the default time zone and locale.
        calendar.add(Calendar.SECOND, t.intValue());
        //	System.out.println(sdf.format(calendar.getTime()));
        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm");
//        etaLabel.setText(sdf.format(calendar.getTime()));
        PublicMapsActivity.etaTimeLabel.setText(sdf.format(calendar.getTime()));
        PublicMapsActivity.etaIslandLabel.setText(PublicMapsActivity.etaIsland);
        PublicMapsActivity.etaPanel.setVisible(true);
